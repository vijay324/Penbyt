...
const SelectionForm: React.FC<Props> = ({ onSubmit, onSearch }) => {
  ...
  const inputClasses = `${
    isDarkMode
      ? "bg-zinc-950 border-zinc-800 text-zinc-400 hover:border-purple-600"
      : "bg-white border-zinc-300 text-black hover:border-purple-600"
  }`;
  const buttonClasses = `${
    isDarkMode
      ? "border-purple-400 border-dotted border-2 bg-transparent text-purple-400 font-semibold hover:text-black hover:bg-purple-400"
      : "border-purple-100 bg-purple-100 text-purple-600"
  }`;
  ...
  return (
    ...
    >
      <h2 className="text-lg sm:text-sm md:text-base lg:text-lg xl:text-xl mb-4">
        Find content by searching the name of the subject. ( OR ) by selecting
        the below columns.
      </h2>
